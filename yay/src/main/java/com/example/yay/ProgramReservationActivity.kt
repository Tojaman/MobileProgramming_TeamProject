...
import com.example.yay.databinding.ActivityProgramReservationBinding
import com.google.android.material.navigation.NavigationView
import com.google.android.material.snackbar.Snackbar

class ProgramReservationActivity : AppCompatActivity(), CustomDialogInterface{
    private lateinit var binding : ActivityProgramReservationBinding
    private lateinit var mypageLogin: Mypage_login

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_program_reservation)

        val binding = ActivityProgramReservationBinding.inflate(layoutInflater)
        ...
        binding.ProgramGotoHomeBtn.setOnClickListener {
