...
import com.example.yay.databinding.ActivitySpaceReservationBinding
import com.google.android.material.navigation.NavigationView
import com.google.android.material.snackbar.Snackbar

class SpaceReserationActivity : AppCompatActivity(), CustomDialogInterface{
    private lateinit var binding : ActivitySpaceReservationBinding
    private lateinit var mypageLogin: Mypage_login

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_space_reservation)

        binding = ActivitySpaceReservationBinding.inflate(layoutInflater)
        ...
        binding.ReserveGotoHomeBtn.setOnClickListener {
