...
class Mypage_main : AppCompatActivity(), CustomDialogInterface{
    private lateinit var binding : ActivityMypageMainBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityMypageMainBinding.inflate(layoutInflater)
