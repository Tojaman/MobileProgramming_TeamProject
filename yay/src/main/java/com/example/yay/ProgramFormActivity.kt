...
import com.example.yay.databinding.ActivityProgramFormBinding
import com.google.android.material.navigation.NavigationView
import com.google.android.material.snackbar.Snackbar

class ProgramFormActivity : AppCompatActivity(), CustomDialogInterface{
    private lateinit var binding : ActivityProgramFormBinding
    private lateinit var mypageLogin: Mypage_login

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_program_form)

        binding = ActivityProgramFormBinding.inflate(layoutInflater)
        ...
        binding.programFormSubmitBtn.setOnClickListener{
            val intent = Intent(this, ProgramReservationActivity::class.java)
